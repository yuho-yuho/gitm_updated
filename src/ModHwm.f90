...
! -----------------------------------------------------------------------------
! Included in GITM since 2016 by Cissi Lin, qingyu zhu, 03/02/2020
! -----------------------------------------------------------------------------
...
module qwm
    ...
    character(128)             :: qwmdefault = 'UA/DataIn/hwm123114.bin'
...
module dwm
    ...
    character(128), parameter  :: dwmdefault = 'UA/DataIn/dwm07b104i.dat'
...
contains
    ...
    subroutine initgd2qd()
        ...
        character(128), parameter   :: datafile='UA/DataIn/gd2qd.dat'
        integer(4)                  :: iterm, n
        integer(4)                  :: j
